...
- DummyJSON simulates create/update/delete but doesn't persist - handle with local state
...
- Follow Nuxt 4 folder structure conventions (see detailed section below)
